...
(function(global){
  ...
  var pilot = Object.assign({}, full, { code:'CDMP-DMF-PILOT', tier:'Draft calibration pilot',
    ...
    blurb:'40 original questions rebuilt after review. DMBOK concepts and scenarios; difficulty is uncalibrated.',
    practiceNote:'Pilot only: all 40 questions repeat on retakes. Difficulty is uncalibrated; a high score is not evidence of exam readiness. Topic counts approximate the official weights. The 36/44-minute limits scale the 90/110-minute full-exam pace; they are our practice settings. The four-option format is provisional because an official option count has not been verified. You may consult your own reference. Detailed feedback appears after submission.' });
  global.CDMPConfig = { full:full, pilot:pilot, version:'0.2.0-draft', sourceChecked:'2026-09-24' };
